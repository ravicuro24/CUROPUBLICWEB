...
function DoctorCategory() {
    ...
    const specialties = [
        { id: 1, name: 'General Physician', icon: <FaUserMd />, color: 'from-teal-500 to-cyan-500', description: 'Primary care for all health concerns' },
        ...
        { id: 8, name: 'Urology', icon: <GiKidneys />, color: 'from-teal-600 to-indigo-600', description: 'Urinary and male reproductive system' },
        ...
        { id: 12, name: 'Pulmonology', icon: <FaLungs />, color: 'from-cyan-500 to-teal-500', description: 'Lungs and respiratory system' },
        { id: 13, name: 'Endocrinology', icon: <FaSyringe />, color: 'from-purple-400 to-pink-400', description: 'Hormones and metabolic disorders' },
        { id: 14, name: 'Nephrology', icon: <GiKidneys />, color: 'from-teal-400 to-cyan-400', description: 'Kidney diseases and dialysis' },
        ...
        { id: 17, name: 'Ophthalmology', icon: <FaEye />, color: 'from-sky-500 to-teal-500', description: 'Eye care and vision correction' },
        ...
        { id: 23, name: 'Diabetology', icon: <FaSyringe />, color: 'from-teal-300 to-cyan-300', description: 'Diabetes management and care' },
    ...
    return (
        <div className="py-16 px-4 md:px-8 lg:px-16 bg-gradient-to-b from-white to-teal-50">
            <div className="container mx-auto">
                ...
                >
                    <div className="relative">
                        <input
                            ...
                            className="w-full px-6 py-4 pl-14 rounded-full border border-gray-300 focus:border-teal-500 focus:ring-2 focus:ring-teal-200 focus:outline-none shadow-lg"
                        />
                ...
                >
                    {specialties.map((specialty) => (
                        <motion.div
                            ...
                            className="group"
                        >
                            <div className="bg-white rounded-2xl p-5 shadow-lg hover:shadow-2xl transition-all duration-300 h-full border border-gray-100 hover:border-teal-200">
                                {/* Icon Container */}
                                ...
                                {/* Content */}
                                <h3 className="font-bold text-gray-800 mb-2 group-hover:text-teal-600 transition-colors line-clamp-2">
                                    {specialty.name}
                                </h3>
                                ...
                                {/* View Button */}
                                <Link to='/doctor/allDoctor' className="w-full cursor-pointer flex items-center justify-center gap-2 py-2 text-sm font-semibold text-teal-600 hover:text-teal-700 group-hover:bg-teal-50 rounded-lg transition-colors">
                                    View Doctors
                ...
                <motion.div
                    ...
                    className="mt-16 bg-gradient-to-r from-teal-50 to-cyan-50 rounded-3xl p-8 md:p-12"
                >
