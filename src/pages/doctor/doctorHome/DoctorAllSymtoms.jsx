            ...
            <div className="flex overflow-x-auto gap-8 mt-2 no-scrollbar">
                {loading
                    ? skeletonArray.map((_, index) => (
                        <div
                            key={index}
                            className="flex flex-col items-center px-7 py-2 rounded-md bg-gray-200 min-w-[90px]"
                        >
                    ...
                    : liveSymptoms.map((item) => (
                        <div
                            ...
                            className="cursor-pointer flex flex-col items-center px-8 py-2 rounded-md min-w-[150px]"
                        >
                            <img
                                src={
                                    item.imageUrl ||
