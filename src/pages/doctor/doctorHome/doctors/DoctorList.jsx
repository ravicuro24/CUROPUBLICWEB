...
function DoctorList() {
    ...
    const doctors = [
        {
            id: 1, image: 'https://media.istockphoto.com/id/469155474/photo/male-docotor-say-thats-ok-wearing-protective-mask.jpg?b=1&s=612x612&w=0&k=20&c=mjp3GO4BQ5OMzZ1ZB5-bML2x-B6K5vlyoj4BevH7g2s=',
            ...
            fees: 1500,
            availability: "Today",
            hospital: "Medicare Heart Center",
            location: "New York",
        ...
        {
            id: 2,
            image: 'https://media.istockphoto.com/id/469155474/photo/male-docotor-say-thats-ok-wearing-protective-mask.jpg?b=1&s=612x612&w=0&k=20&c=mjp3GO4BQ5OMzZ1ZB5-bML2x-B6K5vlyoj4BevH7g2s=',
        ...
        {
            id: 11,
            image: 'https://media.istockphoto.com/id/469155474/photo/male-docotor-say-thats-ok-wearing-protective-mask.jpg?b=1&s=612x612&w=0&k=20&c=mjp3GO4BQ5OMzZ1ZB5-bML2x-B6K5vlyoj4BevH7g2s=', name: "Dr. Lisa Wang",
            specialty: "Dentistry",
            experience: 7,
            rating: 4.7,
            reviews: 234,
            ...
            education: "DDS, Dentistry",
            languages: ["English", "Chinese"]
        },
        {
            id: 12,
            image: 'https://media.istockphoto.com/id/469155474/photo/male-docotor-say-thats-ok-wearing-protective-mask.jpg?b=1&s=612x612&w=0&k=20&c=mjp3GO4BQ5OMzZ1ZB5-bML2x-B6K5vlyoj4BevH7g2s=', name: "Dr. Ahmed Hassan",
            specialty: "ENT",
            experience: 13,
            rating: 4.8,
            reviews: 287,
        ...
        },
        {
            ...
            fees: 2500,
            availability: "Tomorrow",
            hospital: "Heart Excellence Center",
            location: "Houston",
            imageColor: "bg-red-100",
            iconColor: "text-red-600",
            education: "MD, Cardiology",
        ...
        <div className="min-h-screen bg-white p-6">
            <div className="container mx-auto">
                <div className="flex flex-row gap-2 ">
                    <h1 className="text-2xl font-bold md:w-1/4 w-1/2 ">Find Your Doctor</h1>



                    {/* SEARCH */}
                    <div className="relative mb-6 md:w-2/3">
                ...
                {/* 🔥 KEY FIX */}
                <motion.div
                    key={`${searchTerm}-${selectedSpecialty}-${sortBy}`}
                ...
                {filteredDoctors.length === 0 && (
                    <div className="flex flex-col items-center justify-center mt-24 text-gray-500">
                        ...
                        <p className="text-sm text-gray-500 mt-2 text-center max-w-sm">
                            ...
                            Try changing the specialty, name, or location.
                        </p>
                        ...
                        <button
                            ...
                            className="mt-5 px-5 py-2 bg-teal-600 text-white rounded-full text-sm hover:bg-teal-700"
                        >
                            Clear filters
                        </button>
                    </div>
